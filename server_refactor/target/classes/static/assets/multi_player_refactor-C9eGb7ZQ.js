import"./style-Cgk5hXEf.js";const E="",Q=window.location.host,k=document.getElementById("app"),c="kbd kbd-xl text-base sm:text-xl text-pink-200 bg-black h-20",re="kbd kbd-xl text-base sm:text-xl text-pink-200 bg-black h-20",se="kbd kbd-xl text-base sm:text-xl text-pink-200 bg-black font-bold w-16 sm:w-[73px] h-20",X=15;let p=null,u=null,K=!1,_=!1,G=!1,b=null,M=null,L=Promise.resolve(),F=!1,T=null,R=null,q=[];function C(t){return{...t,players:t.players.map(e=>({...e,gameScore:typeof e.gameScore=="number"?e.gameScore:0,totalScore:typeof e.totalScore=="number"?e.totalScore:0})),currentTurn:t.currentTurn?{...t.currentTurn,gameScore:typeof t.currentTurn.gameScore=="number"?t.currentTurn.gameScore:0,totalScore:typeof t.currentTurn.totalScore=="number"?t.currentTurn.totalScore:0}:null}}function ae(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function oe(){return localStorage.getItem("refactor-recent-room-name")}function U(t,e){localStorage.setItem("refactor-recent-room",t),localStorage.setItem("refactor-recent-room-name",e)}function A(){return new URLSearchParams(window.location.search).get("room")}function w(){const t=localStorage.getItem("refactor-chat-user");if(t)return JSON.parse(t);const e={username:`Player${Math.floor(Math.random()*900+100)}`,userId:crypto.randomUUID()};return localStorage.setItem("refactor-chat-user",JSON.stringify(e)),e}function O(t){const e=t.trim().slice(0,X);if(!e)throw new Error("Username is required");const n=w(),r={username:e,userId:n.userId};return localStorage.setItem("refactor-chat-user",JSON.stringify(r)),r}function ie(t,e){const n=localStorage.getItem("refactor-room-memberships"),r=n?JSON.parse(n):{};r[t]=e,localStorage.setItem("refactor-room-memberships",JSON.stringify(r))}function y(t){const e=localStorage.getItem("refactor-room-memberships");return e?JSON.parse(e)[t]??null:null}function le(t,e=!1){const n=w(),r=ae(t),s=!e&&t?`<p class="mt-2 text-sm italic text-black/70">Recent room: <span class="font-bold">${r}</span></p>`:"";return`
      ...
      <div class="bg-white/70 border border-black rounded-md p-6 text-center text-black w-full">
        ...
        <div class="mt-6 flex flex-col gap-6 justify-center items-center">
          ...
          <label class="floating-label w-full">
            <input
              id="room-id-input"
              class="input input-bordered bg-white text-center input-xs sm:input-sm md:input-md lg:input-lg xl:input-xl text-black ${e?"hidden":""}"
              value="${r}"
              placeholder="Room name" />
            <span class="bg-white rounded-lg border border-pink-300 p-1 italic ${e?"hidden":""}">Room Name</span>
          </label>
          <label class="floating-label w-full">
            ${e?`<input class="input input-bordered bg-white text-center input-xs sm:input-sm md:input-md lg:input-lg xl:input-xl text-black" value="${r}" readonly />`:'<button id="create-room-btn" class="btn bg-black text-pink-300 mx-auto">Create New Room</button>'}
            <span class="bg-white rounded-lg border border-pink-300 p-1 italic ${e?"":"hidden"}">Room Name</span>
          </label>
  ...
  `}function B(t=oe()??"",e=!1){k&&(M=null,b=null,k.className="bg-transparent w-full min-h-screen sm:w-3/4 mx-auto p-0 sm:p-1 pb-10",k.innerHTML=le(t,e),pe())}function me(){k&&(k.className="bg-transparent w-full min-h-screen sm:w-3/4 mx-auto p-0 sm:p-1 pb-10",k.innerHTML=de(),Le(),ve(),Ee(),Ie(),$e())}function S(t){k&&(k.className="bg-transparent w-full min-h-screen sm:w-3/4 mx-auto p-4 sm:p-6",k.innerHTML=`
  ...
  `,te(t)}function $(t){return t==="COMPLETED"||t==="FAILED"}function N(){var e;if(!b)return!1;const t=y(b.roomId);return!!(t&&((e=b.currentTurn)==null?void 0:e.playerId)===t)}function Re(t){var i;const e=document.getElementById("playerQueue");if(!e)return;const n=[...t.players].sort((o,l)=>o.turnOrder-l.turnOrder);e.className="mt-3 flex w-full flex-col gap-2";const r=R;e.innerHTML=n.map((o,l)=>{var x;const d=((x=t.currentTurn)==null?void 0:x.playerId)===o.playerId,m=n.findIndex(h=>{var v;return h.playerId===((v=t.currentTurn)==null?void 0:v.playerId)}),f=l===m?"Current":l===(m+1)%n.length?"Next":"";return`
      <div data-player-pill="${o.playerId}" class="flex items-center justify-between rounded-md border px-4 py-2 transition-all duration-500 ease-out overflow-hidden ${d?"border-pink-300 bg-white shadow-sm opacity-100":"border-black bg-white/70 opacity-70"}">
        ...
        <div class="ml-4 flex shrink-0 items-center gap-3">
          ...
          ${f?`<span class="rounded-full p-4 text-[10px] font-semibold uppercase tracking-[0.18em] ${d?"bg-pink-100 text-black":" text-black"}">${f}</span>`:""}
        </div>
      </div>
